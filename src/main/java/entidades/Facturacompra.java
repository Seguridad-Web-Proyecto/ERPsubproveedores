...
public class Facturacompra implements Serializable {
    ...
    @JoinColumn(name = "pagoid_fk", referencedColumnName = "pagocompraid")
    @ManyToOne(optional = false)
    private Pagocompra pagoidFk;

    public Facturacompra() {
    }

    public Facturacompra(Integer facturacompraid) {
        this.facturacompraid = facturacompraid;
    }

    public Facturacompra(Integer facturacompraid, Date fechaEmision, Date fechaVencimientoPago, String descripcion) {
        this.facturacompraid = facturacompraid;
    ...
    public Pagocompra getPagoidFk() {
        return pagoidFk;
    }

    public void setPagoidFk(Pagocompra pagoidFk) {
