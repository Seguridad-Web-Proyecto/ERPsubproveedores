    ...
    public void create(Proveedor proveedor) throws RollbackFailureException, Exception {
        ...
        try {
            ...
            for (Ordencompra ordencompraCollectionOrdencompra : proveedor.getOrdencompraCollection()) {
                Proveedor oldProveedoridFkOfOrdencompraCollectionOrdencompra = ordencompraCollectionOrdencompra.getProveedoridFk();
                ordencompraCollectionOrdencompra.setProveedoridFk(proveedor);
                ordencompraCollectionOrdencompra = em.merge(ordencompraCollectionOrdencompra);
                if (oldProveedoridFkOfOrdencompraCollectionOrdencompra != null) {
                    oldProveedoridFkOfOrdencompraCollectionOrdencompra.getOrdencompraCollection().remove(ordencompraCollectionOrdencompra);
                    oldProveedoridFkOfOrdencompraCollectionOrdencompra = em.merge(oldProveedoridFkOfOrdencompraCollectionOrdencompra);
                }
            }
            utx.commit();
        } catch (Exception ex) {
        ...
        try {
            ...
            for (Ordencompra ordencompraCollectionOldOrdencompra : ordencompraCollectionOld) {
                if (!ordencompraCollectionNew.contains(ordencompraCollectionOldOrdencompra)) {
                    ...
                    illegalOrphanMessages.add("You must retain Ordencompra " + ordencompraCollectionOldOrdencompra + " since its proveedoridFk field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            for (Ordencompra ordencompraCollectionNewOrdencompra : ordencompraCollectionNew) {
                if (!ordencompraCollectionOld.contains(ordencompraCollectionNewOrdencompra)) {
                    Proveedor oldProveedoridFkOfOrdencompraCollectionNewOrdencompra = ordencompraCollectionNewOrdencompra.getProveedoridFk();
                    ordencompraCollectionNewOrdencompra.setProveedoridFk(proveedor);
                    ordencompraCollectionNewOrdencompra = em.merge(ordencompraCollectionNewOrdencompra);
                    if (oldProveedoridFkOfOrdencompraCollectionNewOrdencompra != null && !oldProveedoridFkOfOrdencompraCollectionNewOrdencompra.equals(proveedor)) {
                        oldProveedoridFkOfOrdencompraCollectionNewOrdencompra.getOrdencompraCollection().remove(ordencompraCollectionNewOrdencompra);
                        oldProveedoridFkOfOrdencompraCollectionNewOrdencompra = em.merge(oldProveedoridFkOfOrdencompraCollectionNewOrdencompra);
                    }
                }
            }
            utx.commit();
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            for (Ordencompra ordencompraCollectionOrphanCheckOrdencompra : ordencompraCollectionOrphanCheck) {
                ...
                illegalOrphanMessages.add("This Proveedor (" + proveedor + ") cannot be destroyed since the Ordencompra " + ordencompraCollectionOrphanCheckOrdencompra + " in its ordencompraCollection field has a non-nullable proveedoridFk field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
