    ...
    public void create(Rol rol) throws RollbackFailureException, Exception {
        ...
        try {
            ...
            for (Usuario usuarioCollectionUsuario : rol.getUsuarioCollection()) {
                Rol oldRolidFkOfUsuarioCollectionUsuario = usuarioCollectionUsuario.getRolidFk();
                usuarioCollectionUsuario.setRolidFk(rol);
                usuarioCollectionUsuario = em.merge(usuarioCollectionUsuario);
                if (oldRolidFkOfUsuarioCollectionUsuario != null) {
                    oldRolidFkOfUsuarioCollectionUsuario.getUsuarioCollection().remove(usuarioCollectionUsuario);
                    oldRolidFkOfUsuarioCollectionUsuario = em.merge(oldRolidFkOfUsuarioCollectionUsuario);
                }
            }
            utx.commit();
        } catch (Exception ex) {
        ...
        try {
            ...
            for (Usuario usuarioCollectionOldUsuario : usuarioCollectionOld) {
                if (!usuarioCollectionNew.contains(usuarioCollectionOldUsuario)) {
                    ...
                    illegalOrphanMessages.add("You must retain Usuario " + usuarioCollectionOldUsuario + " since its rolidFk field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            for (Usuario usuarioCollectionNewUsuario : usuarioCollectionNew) {
                if (!usuarioCollectionOld.contains(usuarioCollectionNewUsuario)) {
                    Rol oldRolidFkOfUsuarioCollectionNewUsuario = usuarioCollectionNewUsuario.getRolidFk();
                    usuarioCollectionNewUsuario.setRolidFk(rol);
                    usuarioCollectionNewUsuario = em.merge(usuarioCollectionNewUsuario);
                    if (oldRolidFkOfUsuarioCollectionNewUsuario != null && !oldRolidFkOfUsuarioCollectionNewUsuario.equals(rol)) {
                        oldRolidFkOfUsuarioCollectionNewUsuario.getUsuarioCollection().remove(usuarioCollectionNewUsuario);
                        oldRolidFkOfUsuarioCollectionNewUsuario = em.merge(oldRolidFkOfUsuarioCollectionNewUsuario);
                    }
                }
            }
            utx.commit();
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            for (Usuario usuarioCollectionOrphanCheckUsuario : usuarioCollectionOrphanCheck) {
                ...
                illegalOrphanMessages.add("This Rol (" + rol + ") cannot be destroyed since the Usuario " + usuarioCollectionOrphanCheckUsuario + " in its usuarioCollection field has a non-nullable rolidFk field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
