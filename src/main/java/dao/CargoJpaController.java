    ...
    public void create(Cargo cargo) throws RollbackFailureException, Exception {
        ...
        try {
            ...
            for (Historialtrabajo historialtrabajoCollectionHistorialtrabajo : cargo.getHistorialtrabajoCollection()) {
                Cargo oldCargoidFkOfHistorialtrabajoCollectionHistorialtrabajo = historialtrabajoCollectionHistorialtrabajo.getCargoidFk();
                historialtrabajoCollectionHistorialtrabajo.setCargoidFk(cargo);
                historialtrabajoCollectionHistorialtrabajo = em.merge(historialtrabajoCollectionHistorialtrabajo);
                if (oldCargoidFkOfHistorialtrabajoCollectionHistorialtrabajo != null) {
                    oldCargoidFkOfHistorialtrabajoCollectionHistorialtrabajo.getHistorialtrabajoCollection().remove(historialtrabajoCollectionHistorialtrabajo);
                    oldCargoidFkOfHistorialtrabajoCollectionHistorialtrabajo = em.merge(oldCargoidFkOfHistorialtrabajoCollectionHistorialtrabajo);
                }
            }
            utx.commit();
        } catch (Exception ex) {
        ...
        try {
            ...
            for (Historialtrabajo historialtrabajoCollectionOldHistorialtrabajo : historialtrabajoCollectionOld) {
                if (!historialtrabajoCollectionNew.contains(historialtrabajoCollectionOldHistorialtrabajo)) {
                    ...
                    illegalOrphanMessages.add("You must retain Historialtrabajo " + historialtrabajoCollectionOldHistorialtrabajo + " since its cargoidFk field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            for (Historialtrabajo historialtrabajoCollectionNewHistorialtrabajo : historialtrabajoCollectionNew) {
                if (!historialtrabajoCollectionOld.contains(historialtrabajoCollectionNewHistorialtrabajo)) {
                    Cargo oldCargoidFkOfHistorialtrabajoCollectionNewHistorialtrabajo = historialtrabajoCollectionNewHistorialtrabajo.getCargoidFk();
                    historialtrabajoCollectionNewHistorialtrabajo.setCargoidFk(cargo);
                    historialtrabajoCollectionNewHistorialtrabajo = em.merge(historialtrabajoCollectionNewHistorialtrabajo);
                    if (oldCargoidFkOfHistorialtrabajoCollectionNewHistorialtrabajo != null && !oldCargoidFkOfHistorialtrabajoCollectionNewHistorialtrabajo.equals(cargo)) {
                        oldCargoidFkOfHistorialtrabajoCollectionNewHistorialtrabajo.getHistorialtrabajoCollection().remove(historialtrabajoCollectionNewHistorialtrabajo);
                        oldCargoidFkOfHistorialtrabajoCollectionNewHistorialtrabajo = em.merge(oldCargoidFkOfHistorialtrabajoCollectionNewHistorialtrabajo);
                    }
                }
            }
            utx.commit();
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            for (Historialtrabajo historialtrabajoCollectionOrphanCheckHistorialtrabajo : historialtrabajoCollectionOrphanCheck) {
                ...
                illegalOrphanMessages.add("This Cargo (" + cargo + ") cannot be destroyed since the Historialtrabajo " + historialtrabajoCollectionOrphanCheckHistorialtrabajo + " in its historialtrabajoCollection field has a non-nullable cargoidFk field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
